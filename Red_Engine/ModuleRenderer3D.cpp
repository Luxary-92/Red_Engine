...
#ifdef _DEBUG
#pragma comment (lib, "MathGeoLib/libx86/Math_Debug/MathGeoLib.lib") /* link Microsoft OpenGL lib   */
#else
#pragma comment (lib, "MathGeoLib/libx86/Math_Release/MathGeoLib.lib") /* link Microsoft OpenGL lib   */
#endif // _DEBUG
